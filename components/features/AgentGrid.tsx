...
const PLUGIN_DOCK: Array<PluginDockItem & { prompt: string }> = [
  ...
  },
  {
    ...
    hint: 'Drive this terminal from your phone (Apuchat)',
    color: '#38bdf8',
    icon: <MonitorSmartphone className="h-6 w-6" strokeWidth={1.5} />,
    prompt: 'Use the Apuchat daemon (MCP server named "apuchat" or legacy "rogerthat", https://apuchat.com): call its open_remote_control tool to create a phone remote-control channel for this terminal, then give me the link.',
  },
  {
    id: 'coordination',
    label: 'Coordination',
    hint: 'Coordinate agents on a channel (Apuchat)',
    color: '#a78bfa',
    icon: <Users className="h-6 w-6" strokeWidth={1.5} />,
    prompt: 'Use the Apuchat daemon (MCP server named "apuchat" or legacy "rogerthat", https://apuchat.com): call create_channel to open a coordination channel for this task, post my current status with send, and listen for teammates.',
  },
  {
    id: 'voice',
    label: 'Voice control',
    hint: 'Drive the terminal by voice (Apuchat)',
    color: '#2dd4bf',
    icon: <Mic className="h-6 w-6" strokeWidth={1.5} />,
    prompt: 'Use the Apuchat daemon (MCP server named "apuchat" or legacy "rogerthat", https://meet.apuchat.com): call open_video_call to start a voice session for this terminal so I can dictate prompts, and give me the join link.',
  },
  {
    id: 'meet',
    label: 'Agent meet',
    hint: 'Start a voice / video meet (Apuchat)',
    color: '#f472b6',
    icon: <Video className="h-6 w-6" strokeWidth={1.5} />,
    prompt: 'Use the Apuchat daemon (MCP server named "apuchat" or legacy "rogerthat", https://meet.apuchat.com): call open_video_call to start an agent meet (voice/video) for this session and give me the join link.',
  },
  {
    id: 'prowl',
    label: 'Bench prowl',
