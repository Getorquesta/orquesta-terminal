...
| Platform | Download |
|----------|----------|
| **Linux** · AppImage | [Orquesta.Terminal_0.1.11_amd64.AppImage](https://github.com/Getorquesta/orquesta-terminal/releases/download/v0.1.11/Orquesta.Terminal_0.1.11_amd64.AppImage) |
| **Linux** · Debian/Ubuntu `.deb` | [Orquesta.Terminal_0.1.11_amd64.deb](https://github.com/Getorquesta/orquesta-terminal/releases/download/v0.1.11/Orquesta.Terminal_0.1.11_amd64.deb) |
...
```bash
chmod +x Orquesta.Terminal_0.1.11_amd64.AppImage
./Orquesta.Terminal_0.1.11_amd64.AppImage
```
