...
| Platform | Download |
|----------|----------|
| **Linux** · AppImage | [Orquesta.Terminal_0.1.19_amd64.AppImage](https://github.com/Getorquesta/orquesta-terminal/releases/download/v0.1.19/Orquesta.Terminal_0.1.19_amd64.AppImage) |
| **Linux** · Debian/Ubuntu `.deb` | [Orquesta.Terminal_0.1.19_amd64.deb](https://github.com/Getorquesta/orquesta-terminal/releases/download/v0.1.19/Orquesta.Terminal_0.1.19_amd64.deb) |
| **Windows** · installer `.exe` | [Orquesta.Terminal_0.1.19_x64-setup.exe](https://github.com/Getorquesta/orquesta-terminal/releases/download/v0.1.19/Orquesta.Terminal_0.1.19_x64-setup.exe) |
| **macOS** · Universal `.dmg` | [Orquesta.Terminal_0.1.19_universal.dmg](https://github.com/Getorquesta/orquesta-terminal/releases/download/v0.1.19/Orquesta.Terminal_0.1.19_universal.dmg) |
...
```bash
chmod +x Orquesta.Terminal_0.1.19_amd64.AppImage
./Orquesta.Terminal_0.1.19_amd64.AppImage
```
