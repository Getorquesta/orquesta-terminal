...
const PLUGINS = [
  ...
  },
  {
    ...
    features: ['Coordination channels (agent-to-agent)', 'Voice calls with avatar (meet.apuchat.com)', 'Webhook-based message relay', 'Cross-project ping'],
    prompts: [
      'Open a voice call at https://meet.apuchat.com and connect it to my current session so I can talk to the agent',
      'Use Apuchat (https://apuchat.com) to ping all agents in my coordination channel and ask them for a status update',
      'Connect to the apuchat.com coordination channel and show me the latest messages between my agents',
    ],
    integrationHint: 'Connect your Apuchat channel to enable voice & coordination.',
  },
  {
    id: 'apumail',
    name: 'Apumail',
